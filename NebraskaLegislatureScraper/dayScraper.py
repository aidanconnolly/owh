#This script gets all of the bills presented on a specific day. Information includes the bill name (LB ###), the link to the bill, the DocumentID (used in billInfoScraper.py), the introducer name, the link to the introducer, the status and a description. These are all saved in bills_list.
